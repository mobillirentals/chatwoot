...
ActiveRecord::Schema[7.1].define(version: 2026_07_14_130100) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.boolean "mobilli_assistant_enabled", default: false, null: false
    t.boolean "mobilli_sentiment_enabled", default: false, null: false
    t.boolean "mobilli_quality_enabled", default: false, null: false
    t.boolean "mobilli_sentiment_list_enabled", default: false, null: false
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.string "mobilli_sentiment"
    t.float "mobilli_sentiment_confidence"
    t.datetime "mobilli_sentiment_analyzed_at"
    t.datetime "mobilli_sentiment_activity_at"
    t.datetime "deleted_at"
    t.integer "captain_sentiment"
    t.datetime "captain_sentiment_updated_at"
  ...
  create_table "mobilli_assistant_documents", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "title", null: false
    ...
    t.datetime "updated_at", null: false
    t.string "source_url"
    t.index ["account_id", "source_url"], name: "idx_mobilli_docs_account_source_url", unique: true, where: "(source_url IS NOT NULL)"
    t.index ["account_id"], name: "index_mobilli_assistant_documents_on_account_id"
  end

  create_table "mobilli_assistant_messages", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "mobilli_assistant_thread_id", null: false
    t.string "role", null: false
    t.text "content", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_mobilli_assistant_messages_on_account_id"
    t.index ["mobilli_assistant_thread_id"], name: "index_mobilli_assistant_messages_on_mobilli_assistant_thread_id"
  end

  create_table "mobilli_assistant_threads", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "user_id", null: false
    t.string "title", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "user_id"], name: "index_mobilli_assistant_threads_on_account_id_and_user_id"
    t.index ["account_id"], name: "index_mobilli_assistant_threads_on_account_id"
    t.index ["user_id"], name: "index_mobilli_assistant_threads_on_user_id"
  end

  create_table "mobilli_kb_suggestions", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "title", null: false
    t.string "category"
    t.text "content", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_mobilli_kb_suggestions_on_account_id"
  end

  create_table "mobilli_quality_analyses", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.integer "conversation_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "conversation_id"], name: "idx_mobilli_quality_analyses_account_conversation", unique: true
    t.index ["account_id"], name: "index_mobilli_quality_analyses_on_account_id"
  end
  ...
  add_foreign_key "mobilli_assistant_documents", "accounts"
  add_foreign_key "mobilli_assistant_messages", "accounts"
  add_foreign_key "mobilli_assistant_messages", "mobilli_assistant_threads"
  add_foreign_key "mobilli_assistant_threads", "accounts"
  add_foreign_key "mobilli_assistant_threads", "users"
  add_foreign_key "mobilli_kb_suggestions", "accounts"
  add_foreign_key "mobilli_quality_analyses", "accounts"
