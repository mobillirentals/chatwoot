class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'microsoft' => %w[AZURE_APP_ID AZURE_APP_SECRET AZURE_CLIENT_ID AZURE_CLIENT_SECRET AZURE_TENANT_ID ENABLE_MICROSOFT_SSO_LOGIN],
    ...
    @allowed_configs = mapping.fetch(
      @config,
      %w[ENABLE_ACCOUNT_SIGNUP ENABLE_EMAIL_LOGIN FIREBASE_PROJECT_ID FIREBASE_CREDENTIALS WEBHOOK_TIMEOUT MAXIMUM_FILE_UPLOAD_SIZE WIDGET_TOKEN_EXPIRY]
    )
  end
