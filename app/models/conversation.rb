...
#  captain_sentiment             :integer
#  captain_sentiment_updated_at  :datetime
...
#  mobilli_sentiment             :string
#  mobilli_sentiment_activity_at :datetime
#  mobilli_sentiment_analyzed_at :datetime
#  mobilli_sentiment_confidence  :float
#  priority                      :integer
