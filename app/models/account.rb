...
#  mobilli_assistant_enabled      :boolean          default(FALSE), not null
#  mobilli_quality_enabled        :boolean          default(FALSE), not null
#  mobilli_sentiment_enabled      :boolean          default(FALSE), not null
#  mobilli_sentiment_list_enabled :boolean          default(FALSE), not null
